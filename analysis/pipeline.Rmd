...
In terms of time and memory usage, the example analysis shown in the pipeline vignettes (using SCTransform as normalization method and InSituType Supervised classification for cell typing) takes \~25 minutes to execute, and 62,9 Gb of memory consumption.
...
-   **RC:** \~5 minutes and 34.2 Gb.

-   **Log:** \~5 minutes and 34.2 Gb.

-   **SCT:** \~6 minutes and 34.2 Gb.
...
-   **SCT + Supervised InSituType:** \~25 minutes and 62,9 Gb.

-   **SCT + Unsupervised InSituType:** \~11 minutes and 62,7 Gb.

-   **SCT + Seurat-Louvain:** \~9 minutes and 58,6 Gb.
