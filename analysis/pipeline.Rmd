...
In terms of time and memory usage, the example analysis shown in the pipeline vignettes (using SCTransform as normalization method and InSituType Supervised classification for cell typing) takes 22 minutes and 43 seconds to execute, and 62,9 Gb of memory consumption.
...
-   **RC:** 4min 36sec and 34.2 Gb.

-   **Log:** 4min 8sec and 34.2 Gb.

-   **SCT:** 5min 10sec and 34.2 Gb.
...
-   **SCT + Supervised InSituType:** 22min 43sec to and 62,9 Gb.

-   **SCT + Unsupervised InSituType:** 10min 34sec to and 62,7 Gb.

-   **SCT + Seurat-Louvain:** 8min 54sec and 58,6 Gb.
