...
p2 <- DimPlot(seu_ISTUnsup, reduction = "umap", label = FALSE, cols = cols_ISTUnsup,
              raster = FALSE) +
...
1.  [Cell typing with InSituType Supervised classification](4.0_insitutype_cell_typing.html)
...
2.  [Unsupervised clustering with InSituType + ScType annotation based on markers](4.1_insitutype_unsup_clustering.html)
...
3.  [Unsupervised clustering with Seurat-Louvain + ScType annotation based on markers](4.2_seurat_unsup_clustering.html)
