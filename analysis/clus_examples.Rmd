...
Overall, unsupervised InSituType is

, but provides full cell annotation based on a very reliable profile and seems more memory efficient overall, showing very reduced memory consumption in the Unsupervised method and very comparable values between the supervised method and the unsupervised Seurat's approach.  
