...
In terms of time and memory usage, methods "RC" and "LogNormalize" (including "FindVariableFeatures" and "ScaleData") are both less memory and time consuming, while "SCTransform" requires higher computing resources.
